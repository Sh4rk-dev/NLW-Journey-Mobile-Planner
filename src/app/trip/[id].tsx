  ...
  async function handleUpdateTrip() {
    try {
      ...
      if (!destination || !selectedDates.startsAt || !selectedDates.endsAt) {
        return Alert.alert(
          "Atualizar viagem",
          "Lembre-se de, além de preencher o destino, selecione uma data de início e fim da viagem."
        );
      }
      ...
      >
        <View className="gap-4 mt4">
          <Text className="text-zinc-400 font-regular leading-6 my-2">
            ...
            Para confirmar sua preseça na viagem, preencha os dados abaixo:
          </Text>
