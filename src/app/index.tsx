...
export default function Index() {
  ...
  function handleAddEmail() {
    ...
    if (emailAlreadyExists) {
      return Alert.alert("Convidade", "E-mail já foi adicionado!");
    }
  ...
  return (
    <View className="flex-1 justify-center items-center px-5">
      ...
      <Text className="text-zinc-500 font-regular text-center text-base">
        Ao planejar sua viagem pela plann.er você automaticamente concorda com o
        nosso{" "}
      ...
      <Modal
        ...
        subtitle="Os convidados irão receber e-mais para confirmar a participação na viagem."
